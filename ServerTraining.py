...
train = True
if train:
    inputs = np.load("masterInputs.npy")[0:12000]
    outputs = np.load("masterOutputs.npy")[0:12000]*20
    ...
    trainNetwork(inputs, outputs, loadDirectory="supervisedSMALL.pt", saveDirectory="supervisedSMALL.pt", EPOCHS=1000,
