...
def trainNetwork(states, outputMoves, EPOCHS=10000, BATCH_SIZE=1000, LR=0.001, loadDirectory='none.pt',
    ...
    model = ChessConvNet(OUTPUT_ARRAY_LEN).cuda()

    # this is a residual network
    # model = ChessResNet.ResNet18().cuda()
...
if train:
    ...
    trainNetwork(inputs, outputs, loadDirectory="nothing.pt", saveDirectory="sFULL-2LAYER-10.pt", EPOCHS=1000,
